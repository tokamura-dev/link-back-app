...
const USERS_PRIMARY_KEY_COUNT = 1
...
type Users struct {
	...
	UpdatedDate       sql.NullTime `xorm:"updated_date"`         /** 更新日時 */
}

/**
 * ユーザー情報1件取得のリクエスト
 */
type RequestOneByEmployeeIdUsers struct {
	EmployeeId string `form:"employeeId" binding:"required,max=6"`
}
